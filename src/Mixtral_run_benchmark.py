"""Mistral-family runner for the step-wise MacGyver benchmark (paper §5).

Selects the specific Mistral variant via ``sys.argv[1]`` (mistral,
mistral-nemo, mistral-large, ministral, mixtral).
"""
