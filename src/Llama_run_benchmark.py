"""Llama-family runner for the step-wise MacGyver benchmark (paper §5).

Selects the specific Llama variant via ``sys.argv[1]`` (llama, llama30,
llama3-70b, llama_70b, llama3.3, llama3.2, llama3.21b, llama2) and
populates the module-level ``fullscale_*`` arrays consumed by
``src.process_data``.
"""
