"""Single-agent and ChatEval LLM-as-a-judge baselines used in paper Table 2
for comparison against the retrieval-based multi-agent judge (see
``src/LLMevalframeworks.py``). Provides the one-shot / chain-of-thought /
few-shot variants in both binary and Likert regimes, all against GPT-4o.
"""
...
if __name__ == '__main__':
    prepare_df
    # NOTE: filename list is hard-coded to the GPT-4o T=1.0 run that seeded
    # the baselines in paper Table 2. Edit this list to re-run on other
    # result files.
